...
def prepare_notebook_context(
    *,
    ...
    from cqed_sim.analysis.experiment_convention_audit import run_full_audit
    ...
    simulation_inspected = [
        sim_root / "cqed_sim" / "analysis" / "experiment_convention_audit.py",
        sim_root / "cqed_sim" / "analysis" / "experiment_convention_audit_notebook.py",
        ...
        sim_root / "cqed_sim" / "simulators" / "pulse_unitary.py",
        sim_root / "tests" / "test_16_ideal_primitives_and_extractors.py",
        sim_root / "tests" / "test_20_gaussian_iq_convention.py",
        sim_root / "tests" / "test_26_experiment_convention_audit.py",
        sim_root / "cqed_sim" / "tests" / "test_sanity.py",
        sim_root / "cqed_sim" / "tests" / "test_sqr_calibration.py",
    ]
...
- The simulator had one remaining runtime mismatch: a flipped-Y Bloch extractor. That has now been changed to standard Pauli coordinates so it matches the restored experiment convention.
...
- `cqed_sim` runtime Bloch extraction: standardized to match experiment
